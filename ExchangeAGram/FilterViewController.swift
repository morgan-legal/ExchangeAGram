...
class FilterViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func createUIAlertController (indexPath: NSIndexPath)
    {
        ...
        //Add action post photo on facebook to our UIAlertController
        ...
        //Add action save picture with filter to our UIAlertController
        ...
        //Add action cancel to our UIAlertController
    ...
    func shareToFacebook (indexPath: NSIndexPath)
    {
        ...
        FBDialogs.presentShareDialogWithPhotoParams(params, clientState: nil)
        {
